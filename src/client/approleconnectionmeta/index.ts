 ...
 * 	A representation of role connection metadata for an application. [Discord Docs](https://discord.com/developers/docs/resources/application-role-connection-metadata)
 */
export default class ApplicationRoleConnectionMetadataEndpoints extends EndpointGroup {
